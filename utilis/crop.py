...
keypoints_dir = 'data/2d_poses' # Path of joint point files
frames_base_dir = 'data_long_jump/frames' # Path of full image files
...
# Process 26 video segments (01 to 26, Change as needed)
for i in range(1, 27):  
